...
-- two levels deep, camelCase:
--   offering_config->'offeringFundingConfiguration'->'rmf'->>'thresholdDollarAmount'
...
-- override it, though in practice the template's offeringFundingConfiguration
-- didn't carry an "rmf" key for the example checked. Sibling key
-- emergencyThresholdDollarAmount is also pulled.
...
(coalesce(
  o.offering_config->'offeringFundingConfiguration'->'rmf'->>'thresholdDollarAmount',
  ot.offering_config->'offeringFundingConfiguration'->'rmf'->>'thresholdDollarAmount'
))::numeric as threshold_dollar_amount,
(coalesce(
  o.offering_config->'offeringFundingConfiguration'->'rmf'->>'emergencyThresholdDollarAmount',
  ot.offering_config->'offeringFundingConfiguration'->'rmf'->>'emergencyThresholdDollarAmount'
))::numeric as emergency_threshold_dollar_amount
